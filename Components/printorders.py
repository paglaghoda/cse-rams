...
class PrintOrders(tk.Toplevel):
    ...
    def print_receipt(self):
        ...
        with open(r"C:\Users\omkar\Downloads\projects\RestaurantManagementSystem-main\RestaurantManagementSystem-main\BASE\Components\order_template.html") as html_doc:
